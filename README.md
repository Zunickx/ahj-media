...
### Задача 10.1 Текстовые записи с координатами
...
### Задача 10.2 Аудио-записи с координатами* (задача со звёздочкой)
...
### Задача 10.3 Видео-записи с координатами* (задача со звёздочкой)
